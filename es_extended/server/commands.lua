...
ESX.RegisterCommand('job2', { "user", "admin" }, function(xPlayer, _, _)
	print(('%s, your gang is: ^5%s^0 - ^5%s^0'):format(xPlayer.getName(), xPlayer.getJob2().name,
...
ESX.RegisterCommand('info2', { "user", "admin" }, function(xPlayer)
	...
	print(('^2ID: ^5%s^0 | ^2Name: ^5%s^0 | ^2Group: ^5%s^0 | ^2Gang: ^5%s^0'):format(xPlayer.source, xPlayer.getName(),
		xPlayer.getGroup(), job2))
end, false)
